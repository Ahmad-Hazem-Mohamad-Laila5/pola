...
import WomenProductData from "@/app/JsonData/WomensProduct.json";
...
type Product = (typeof WomenProductData)[0];
...
const WomensProduct = () => {
  ...
  const sortedProducts = [...WomenProductData].sort((a, b) => {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {visibleProducts.map((product) => (
            ...
            >
              {/* Product Image */}
              <Link
                href={`/Pages/WomensProduct/${product.id}`}
